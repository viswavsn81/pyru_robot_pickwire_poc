...
def main():
    ...
    while True:
        ...
        if target_pos is None:
            ...
            # FIX: REMOVED THE AUTO-RESET JUMP
            # We accept the robot's current position, even if weird.
            # This prevents the sudden startup jerk.
        ...
        for name in motor_names:
            ...
            if name == "gripper":
                ...
                # CRITICAL SAFETY: Clamp Output to prevent ValueErrors
                # This ensures we never send crazy values like 33,000 degrees
