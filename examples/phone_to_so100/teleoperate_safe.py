...
def main():
    ...
    while True:
        ...
        if target_pos is None:
            ...
            # If Z is weirdly negative (underground), force it up to 10cm
            if target_pos[2] < -0.1:
                print(f"⚠️ Warning: Initial Z was {target_pos[2]}, resetting to 0.1m")
                target_pos[2] = 0.1
        ...
        # Safety Clip Z to prevent floor collision
        if target_pos[2] < -0.05: target_pos[2] = -0.05
        if target_pos[2] > 0.5: target_pos[2] = 0.5
        ...
        for name in motor_names:
            ...
            if name == "gripper":
                ...
                # CRITICAL FIX: Clamp Output to prevent ValueErrors!
